...
In this file are 2 games that I made using the turtle module.
    1 is ech a schech - a drawing game where you can draw using the arrow keys.
    2 is a turtle racae - a game that you can bet on a turtle and see who wins.
"""
