...
def hands(nr_cards):
    """This function makes the hand meaning it adds cards from the CARDS constant

    Args:
        n int: takes in a integer meaning nr of cards you want to add to a list
...
def check_hand(hand):
    """This function takes in a list and checks for the value of the cards

    Args:
        hand list: takes a list of cards

    Returns:
        tuple: returns a tuple of aces and points
    """
    points = 0
    aces = 0
    for card in hand:
...
def aces_logic(nr_aces):
    """Calculates the value of the aces

    Args:
        n int: the number of aces in your hand (tuple)

    Returns:
        int: the value of the aces
    """
    total_ace_value = 0

    for i in range(nr_aces):
...
def adjust_computer_ace_value(hand, hand_info):
    """Gives the value of the ace for the computer hand

    Args:
        hand (list): list of cards
        hand_info (int): nr of points and nr of aces

    Returns:
        list: the points of the aces
    """
...
def game_logic(player_points=int, computer_points=int):
    ...
    Args:
        player_points (int, optional): takes in the points of the player. Defaults to int.
        computer_points (int, optional): takes in the points of the computer. Defaults to int.
    """
    if player_points > 21:
...
def main():
    """This is the main function that contains the game of BlackJack"""
    game = True
    comp_hand = []
    player_hand = []
    balance = 0
